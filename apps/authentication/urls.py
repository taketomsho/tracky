...
from .views import login_view, register_user, PasswordReset, PasswordResetDone, PasswordResetConfirm, PasswordResetComplete, EmailChange, EmailChangeDone, EmailChangeComplete, PasswordChange, PasswordChangeDone
